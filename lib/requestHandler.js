...
function userRequestHandler(req,userRes){
    ...
    */
    ...
    function routeReq(callback){
        ...
        }else if (userRule.shouldUseWormholeResponse(req, reqData)) {
            logUtil.printLog("==>will forward to wormhole server");
            dealWithWormholeResponse(callback);
        } else {
    ...
    function dealWithWormholeResponse(callback){
        var options;
        ...
        wormhole.proxy(protocol, options, reqData, callback);
    }
